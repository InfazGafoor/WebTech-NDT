            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-secondary">
                ...
                <div className="collapse navbar-collapse" id="navbarText">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item active">
                            <Link className="nav-link btn btn-light text-dark" style={{ marginLeft: "20px", width: "140px" }} to="/prot">View Profile </Link>
                        </li>
                        <li className="nav-item active">
                            <Link className="nav-link btn btn-light text-dark" style={{ marginLeft: "20px", width: "120px" }} to="/rest">View Result </Link>
                        </li>
